...
pub const PQCLEAN_DILITHIUM2_AARCH64_CRYPTO_SECRETKEYBYTES: usize = 2528;
#[cfg(enable_aarch64_neon)]
...
#[cfg(enable_x86_avx2)]
pub const PQCLEAN_DILITHIUM5_AVX2_CRYPTO_BYTES: usize = 4595;

#[cfg(enable_aarch64_neon)]
pub const PQCLEAN_DILITHIUM5_AARCH64_CRYPTO_SECRETKEYBYTES: usize = 4864;
#[cfg(enable_aarch64_neon)]
pub const PQCLEAN_DILITHIUM5_AARCH64_CRYPTO_PUBLICKEYBYTES: usize = 2592;
#[cfg(enable_aarch64_neon)]
pub const PQCLEAN_DILITHIUM5_AARCH64_CRYPTO_BYTES: usize = 4595;

pub const PQCLEAN_DILITHIUM2AES_CLEAN_CRYPTO_SECRETKEYBYTES: usize = 2528;
pub const PQCLEAN_DILITHIUM2AES_CLEAN_CRYPTO_PUBLICKEYBYTES: usize = 1312;
pub const PQCLEAN_DILITHIUM2AES_CLEAN_CRYPTO_BYTES: usize = 2420;

#[cfg(enable_x86_avx2)]
pub const PQCLEAN_DILITHIUM2AES_AVX2_CRYPTO_SECRETKEYBYTES: usize = 2528;
#[cfg(enable_x86_avx2)]
pub const PQCLEAN_DILITHIUM2AES_AVX2_CRYPTO_PUBLICKEYBYTES: usize = 1312;
#[cfg(enable_x86_avx2)]
pub const PQCLEAN_DILITHIUM2AES_AVX2_CRYPTO_BYTES: usize = 2420;

pub const PQCLEAN_DILITHIUM3AES_CLEAN_CRYPTO_SECRETKEYBYTES: usize = 4000;
pub const PQCLEAN_DILITHIUM3AES_CLEAN_CRYPTO_PUBLICKEYBYTES: usize = 1952;
pub const PQCLEAN_DILITHIUM3AES_CLEAN_CRYPTO_BYTES: usize = 3293;

#[cfg(enable_x86_avx2)]
pub const PQCLEAN_DILITHIUM3AES_AVX2_CRYPTO_SECRETKEYBYTES: usize = 4000;
#[cfg(enable_x86_avx2)]
pub const PQCLEAN_DILITHIUM3AES_AVX2_CRYPTO_PUBLICKEYBYTES: usize = 1952;
#[cfg(enable_x86_avx2)]
pub const PQCLEAN_DILITHIUM3AES_AVX2_CRYPTO_BYTES: usize = 3293;

pub const PQCLEAN_DILITHIUM5AES_CLEAN_CRYPTO_SECRETKEYBYTES: usize = 4864;
pub const PQCLEAN_DILITHIUM5AES_CLEAN_CRYPTO_PUBLICKEYBYTES: usize = 2592;
pub const PQCLEAN_DILITHIUM5AES_CLEAN_CRYPTO_BYTES: usize = 4595;

#[cfg(enable_x86_avx2)]
pub const PQCLEAN_DILITHIUM5AES_AVX2_CRYPTO_SECRETKEYBYTES: usize = 4864;
#[cfg(enable_x86_avx2)]
pub const PQCLEAN_DILITHIUM5AES_AVX2_CRYPTO_PUBLICKEYBYTES: usize = 2592;
#[cfg(enable_x86_avx2)]
pub const PQCLEAN_DILITHIUM5AES_AVX2_CRYPTO_BYTES: usize = 4595;
...
#[link(name = "dilithium2aes_clean")]
extern "C" {
    pub fn PQCLEAN_DILITHIUM2AES_CLEAN_crypto_sign_keypair(pk: *mut u8, sk: *mut u8) -> c_int;
    pub fn PQCLEAN_DILITHIUM2AES_CLEAN_crypto_sign(
        sm: *mut u8,
        smlen: *mut usize,
        msg: *const u8,
        len: usize,
    ...
    pub fn PQCLEAN_DILITHIUM2AES_CLEAN_crypto_sign_open(
        m: *mut u8,
        mlen: *mut usize,
        sm: *const u8,
        smlen: usize,
    ...
    pub fn PQCLEAN_DILITHIUM2AES_CLEAN_crypto_sign_signature(
        sig: *mut u8,
        siglen: *mut usize,
        m: *const u8,
        mlen: usize,
    ...
    pub fn PQCLEAN_DILITHIUM2AES_CLEAN_crypto_sign_verify(
        sig: *const u8,
        siglen: usize,
        m: *const u8,
        mlen: usize,
...
#[cfg(enable_x86_avx2)]
#[link(name = "dilithium2aes_avx2")]
extern "C" {
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM2AES_AVX2_crypto_sign_keypair(pk: *mut u8, sk: *mut u8) -> c_int;
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM2AES_AVX2_crypto_sign(
        sm: *mut u8,
        smlen: *mut usize,
        msg: *const u8,
        len: usize,
    ...
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM2AES_AVX2_crypto_sign_open(
        m: *mut u8,
        mlen: *mut usize,
        sm: *const u8,
        smlen: usize,
    ...
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM2AES_AVX2_crypto_sign_signature(
        sig: *mut u8,
        siglen: *mut usize,
        m: *const u8,
        mlen: usize,
    ...
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM2AES_AVX2_crypto_sign_verify(
        sig: *const u8,
        siglen: usize,
        m: *const u8,
        mlen: usize,
...
#[link(name = "dilithium3aes_clean")]
extern "C" {
    pub fn PQCLEAN_DILITHIUM3AES_CLEAN_crypto_sign_keypair(pk: *mut u8, sk: *mut u8) -> c_int;
    pub fn PQCLEAN_DILITHIUM3AES_CLEAN_crypto_sign(
        sm: *mut u8,
        smlen: *mut usize,
        msg: *const u8,
        len: usize,
    ...
    pub fn PQCLEAN_DILITHIUM3AES_CLEAN_crypto_sign_open(
        m: *mut u8,
        mlen: *mut usize,
        sm: *const u8,
        smlen: usize,
    ...
    pub fn PQCLEAN_DILITHIUM3AES_CLEAN_crypto_sign_signature(
        sig: *mut u8,
        siglen: *mut usize,
        m: *const u8,
        mlen: usize,
    ...
    pub fn PQCLEAN_DILITHIUM3AES_CLEAN_crypto_sign_verify(
        sig: *const u8,
        siglen: usize,
        m: *const u8,
        mlen: usize,
...
#[cfg(enable_x86_avx2)]
#[link(name = "dilithium3aes_avx2")]
extern "C" {
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM3AES_AVX2_crypto_sign_keypair(pk: *mut u8, sk: *mut u8) -> c_int;
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM3AES_AVX2_crypto_sign(
        sm: *mut u8,
        smlen: *mut usize,
        msg: *const u8,
        len: usize,
    ...
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM3AES_AVX2_crypto_sign_open(
        m: *mut u8,
        mlen: *mut usize,
        sm: *const u8,
        smlen: usize,
    ...
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM3AES_AVX2_crypto_sign_signature(
        sig: *mut u8,
        siglen: *mut usize,
        m: *const u8,
        mlen: usize,
    ...
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM3AES_AVX2_crypto_sign_verify(
        sig: *const u8,
        siglen: usize,
        m: *const u8,
        mlen: usize,
...
#[link(name = "dilithium5aes_clean")]
extern "C" {
    pub fn PQCLEAN_DILITHIUM5AES_CLEAN_crypto_sign_keypair(pk: *mut u8, sk: *mut u8) -> c_int;
    pub fn PQCLEAN_DILITHIUM5AES_CLEAN_crypto_sign(
        sm: *mut u8,
        smlen: *mut usize,
        msg: *const u8,
        len: usize,
    ...
    pub fn PQCLEAN_DILITHIUM5AES_CLEAN_crypto_sign_open(
        m: *mut u8,
        mlen: *mut usize,
        sm: *const u8,
        smlen: usize,
    ...
    pub fn PQCLEAN_DILITHIUM5AES_CLEAN_crypto_sign_signature(
        sig: *mut u8,
        siglen: *mut usize,
        m: *const u8,
        mlen: usize,
    ...
    pub fn PQCLEAN_DILITHIUM5AES_CLEAN_crypto_sign_verify(
        sig: *const u8,
        siglen: usize,
        m: *const u8,
        mlen: usize,
...
#[cfg(enable_x86_avx2)]
#[link(name = "dilithium5aes_avx2")]
extern "C" {
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM5AES_AVX2_crypto_sign_keypair(pk: *mut u8, sk: *mut u8) -> c_int;
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM5AES_AVX2_crypto_sign(
        sm: *mut u8,
        smlen: *mut usize,
        msg: *const u8,
        len: usize,
    ...
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM5AES_AVX2_crypto_sign_open(
        m: *mut u8,
        mlen: *mut usize,
        sm: *const u8,
        smlen: usize,
    ...
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM5AES_AVX2_crypto_sign_signature(
        sig: *mut u8,
        siglen: *mut usize,
        m: *const u8,
        mlen: usize,
    ...
    #[cfg(enable_x86_avx2)]
    pub fn PQCLEAN_DILITHIUM5AES_AVX2_crypto_sign_verify(
        sig: *const u8,
        siglen: usize,
        m: *const u8,
        mlen: usize,
...
mod test_dilithium2aes_clean {
    ...
    fn test_ffi() {
        unsafe {
            ...
            let mut pk = vec![0u8; PQCLEAN_DILITHIUM2AES_CLEAN_CRYPTO_PUBLICKEYBYTES];
            let mut sk = vec![0u8; PQCLEAN_DILITHIUM2AES_CLEAN_CRYPTO_SECRETKEYBYTES];
            let mut pk_alt = vec![0u8; PQCLEAN_DILITHIUM2AES_CLEAN_CRYPTO_PUBLICKEYBYTES];
            let mut sk_alt = vec![0u8; PQCLEAN_DILITHIUM2AES_CLEAN_CRYPTO_SECRETKEYBYTES];
            let mut detached_sig = vec![0u8; PQCLEAN_DILITHIUM2AES_CLEAN_CRYPTO_BYTES];
            let mut sm = Vec::with_capacity(mlen + PQCLEAN_DILITHIUM2AES_CLEAN_CRYPTO_BYTES);
            let mut smlen = 0;
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM2AES_CLEAN_crypto_sign_keypair(pk.as_mut_ptr(), sk.as_mut_ptr())
            );
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM2AES_CLEAN_crypto_sign(
                    sm.as_mut_ptr(),
                    &mut smlen as *mut usize,
                    msg.as_ptr(),
                    mlen,
            ...
            let mut unpacked_m =
                Vec::with_capacity(mlen + PQCLEAN_DILITHIUM2AES_CLEAN_CRYPTO_BYTES);
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM2AES_CLEAN_crypto_sign_open(
                    unpacked_m.as_mut_ptr(),
                    &mut mlen as *mut usize,
                    sm.as_ptr(),
                    sm.len(),
            ...
            assert!(
                smlen <= PQCLEAN_DILITHIUM2AES_CLEAN_CRYPTO_BYTES,
                "Signed message length should be ≤ CRYPTO_BYTES"
            );
            assert_eq!(
                0,
...
mod test_dilithium2aes_avx2 {
    ...
    fn test_ffi() {
        ...
        unsafe {
            ...
            let mut pk = vec![0u8; PQCLEAN_DILITHIUM2AES_AVX2_CRYPTO_PUBLICKEYBYTES];
            let mut sk = vec![0u8; PQCLEAN_DILITHIUM2AES_AVX2_CRYPTO_SECRETKEYBYTES];
            let mut pk_alt = vec![0u8; PQCLEAN_DILITHIUM2AES_AVX2_CRYPTO_PUBLICKEYBYTES];
            let mut sk_alt = vec![0u8; PQCLEAN_DILITHIUM2AES_AVX2_CRYPTO_SECRETKEYBYTES];
            let mut detached_sig = vec![0u8; PQCLEAN_DILITHIUM2AES_AVX2_CRYPTO_BYTES];
            let mut sm = Vec::with_capacity(mlen + PQCLEAN_DILITHIUM2AES_AVX2_CRYPTO_BYTES);
            let mut smlen = 0;
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM2AES_AVX2_crypto_sign_keypair(pk.as_mut_ptr(), sk.as_mut_ptr())
            );
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM2AES_AVX2_crypto_sign(
                    sm.as_mut_ptr(),
                    &mut smlen as *mut usize,
                    msg.as_ptr(),
                    mlen,
            ...
            let mut unpacked_m = Vec::with_capacity(mlen + PQCLEAN_DILITHIUM2AES_AVX2_CRYPTO_BYTES);
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM2AES_AVX2_crypto_sign_open(
                    unpacked_m.as_mut_ptr(),
                    &mut mlen as *mut usize,
                    sm.as_ptr(),
                    sm.len(),
            ...
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM2AES_AVX2_crypto_sign_signature(
                    detached_sig.as_mut_ptr(),
                    &mut smlen as *mut usize,
                    msg.as_ptr(),
                    msg.len(),
            ...
            assert!(
                smlen <= PQCLEAN_DILITHIUM2AES_AVX2_CRYPTO_BYTES,
                "Signed message length should be ≤ CRYPTO_BYTES"
            );
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM2AES_AVX2_crypto_sign_verify(
                    detached_sig.as_ptr(),
                    smlen,
                    msg.as_ptr(),
                    msg.len(),
...
mod test_dilithium3aes_clean {
    ...
    fn test_ffi() {
        unsafe {
            ...
            let mut pk = vec![0u8; PQCLEAN_DILITHIUM3AES_CLEAN_CRYPTO_PUBLICKEYBYTES];
            let mut sk = vec![0u8; PQCLEAN_DILITHIUM3AES_CLEAN_CRYPTO_SECRETKEYBYTES];
            let mut pk_alt = vec![0u8; PQCLEAN_DILITHIUM3AES_CLEAN_CRYPTO_PUBLICKEYBYTES];
            let mut sk_alt = vec![0u8; PQCLEAN_DILITHIUM3AES_CLEAN_CRYPTO_SECRETKEYBYTES];
            let mut detached_sig = vec![0u8; PQCLEAN_DILITHIUM3AES_CLEAN_CRYPTO_BYTES];
            let mut sm = Vec::with_capacity(mlen + PQCLEAN_DILITHIUM3AES_CLEAN_CRYPTO_BYTES);
            let mut smlen = 0;
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM3AES_CLEAN_crypto_sign_keypair(pk.as_mut_ptr(), sk.as_mut_ptr())
            );
            assert_eq!(
                0,
            ...
            let mut unpacked_m =
                Vec::with_capacity(mlen + PQCLEAN_DILITHIUM3AES_CLEAN_CRYPTO_BYTES);
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM3AES_CLEAN_crypto_sign_open(
                    unpacked_m.as_mut_ptr(),
                    &mut mlen as *mut usize,
                    sm.as_ptr(),
                    sm.len(),
            ...
            assert!(
                smlen <= PQCLEAN_DILITHIUM3AES_CLEAN_CRYPTO_BYTES,
                "Signed message length should be ≤ CRYPTO_BYTES"
            );
            assert_eq!(
                0,
...
mod test_dilithium3aes_avx2 {
    ...
    fn test_ffi() {
        ...
        unsafe {
            ...
            let mut pk = vec![0u8; PQCLEAN_DILITHIUM3AES_AVX2_CRYPTO_PUBLICKEYBYTES];
            let mut sk = vec![0u8; PQCLEAN_DILITHIUM3AES_AVX2_CRYPTO_SECRETKEYBYTES];
            let mut pk_alt = vec![0u8; PQCLEAN_DILITHIUM3AES_AVX2_CRYPTO_PUBLICKEYBYTES];
            let mut sk_alt = vec![0u8; PQCLEAN_DILITHIUM3AES_AVX2_CRYPTO_SECRETKEYBYTES];
            let mut detached_sig = vec![0u8; PQCLEAN_DILITHIUM3AES_AVX2_CRYPTO_BYTES];
            let mut sm = Vec::with_capacity(mlen + PQCLEAN_DILITHIUM3AES_AVX2_CRYPTO_BYTES);
            let mut smlen = 0;
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM3AES_AVX2_crypto_sign_keypair(pk.as_mut_ptr(), sk.as_mut_ptr())
            );
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM3AES_AVX2_crypto_sign(
                    sm.as_mut_ptr(),
                    &mut smlen as *mut usize,
                    msg.as_ptr(),
                    mlen,
            ...
            let mut unpacked_m = Vec::with_capacity(mlen + PQCLEAN_DILITHIUM3AES_AVX2_CRYPTO_BYTES);
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM3AES_AVX2_crypto_sign_open(
                    unpacked_m.as_mut_ptr(),
                    &mut mlen as *mut usize,
                    sm.as_ptr(),
                    sm.len(),
            ...
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM3AES_AVX2_crypto_sign_signature(
                    detached_sig.as_mut_ptr(),
                    &mut smlen as *mut usize,
                    msg.as_ptr(),
                    msg.len(),
            ...
            assert!(
                smlen <= PQCLEAN_DILITHIUM3AES_AVX2_CRYPTO_BYTES,
                "Signed message length should be ≤ CRYPTO_BYTES"
            );
            assert_eq!(
                0,
...
mod test_dilithium5aes_clean {
    ...
    fn test_ffi() {
        unsafe {
            ...
            let mut pk = vec![0u8; PQCLEAN_DILITHIUM5AES_CLEAN_CRYPTO_PUBLICKEYBYTES];
            let mut sk = vec![0u8; PQCLEAN_DILITHIUM5AES_CLEAN_CRYPTO_SECRETKEYBYTES];
            let mut pk_alt = vec![0u8; PQCLEAN_DILITHIUM5AES_CLEAN_CRYPTO_PUBLICKEYBYTES];
            let mut sk_alt = vec![0u8; PQCLEAN_DILITHIUM5AES_CLEAN_CRYPTO_SECRETKEYBYTES];
            let mut detached_sig = vec![0u8; PQCLEAN_DILITHIUM5AES_CLEAN_CRYPTO_BYTES];
            let mut sm = Vec::with_capacity(mlen + PQCLEAN_DILITHIUM5AES_CLEAN_CRYPTO_BYTES);
            let mut smlen = 0;
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM5AES_CLEAN_crypto_sign_keypair(pk.as_mut_ptr(), sk.as_mut_ptr())
            );
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM5AES_CLEAN_crypto_sign(
                    sm.as_mut_ptr(),
                    &mut smlen as *mut usize,
                    msg.as_ptr(),
                    mlen,
            ...
            let mut unpacked_m =
                Vec::with_capacity(mlen + PQCLEAN_DILITHIUM5AES_CLEAN_CRYPTO_BYTES);
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM5AES_CLEAN_crypto_sign_open(
                    unpacked_m.as_mut_ptr(),
                    &mut mlen as *mut usize,
                    sm.as_ptr(),
                    sm.len(),
            ...
            assert!(
                smlen <= PQCLEAN_DILITHIUM5AES_CLEAN_CRYPTO_BYTES,
                "Signed message length should be ≤ CRYPTO_BYTES"
            );
            assert_eq!(
                0,
...
mod test_dilithium5aes_avx2 {
    ...
    fn test_ffi() {
        ...
        unsafe {
            ...
            let mut pk = vec![0u8; PQCLEAN_DILITHIUM5AES_AVX2_CRYPTO_PUBLICKEYBYTES];
            let mut sk = vec![0u8; PQCLEAN_DILITHIUM5AES_AVX2_CRYPTO_SECRETKEYBYTES];
            let mut pk_alt = vec![0u8; PQCLEAN_DILITHIUM5AES_AVX2_CRYPTO_PUBLICKEYBYTES];
            let mut sk_alt = vec![0u8; PQCLEAN_DILITHIUM5AES_AVX2_CRYPTO_SECRETKEYBYTES];
            let mut detached_sig = vec![0u8; PQCLEAN_DILITHIUM5AES_AVX2_CRYPTO_BYTES];
            let mut sm = Vec::with_capacity(mlen + PQCLEAN_DILITHIUM5AES_AVX2_CRYPTO_BYTES);
            let mut smlen = 0;
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM5AES_AVX2_crypto_sign_keypair(pk.as_mut_ptr(), sk.as_mut_ptr())
            );
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM5AES_AVX2_crypto_sign(
                    sm.as_mut_ptr(),
                    &mut smlen as *mut usize,
                    msg.as_ptr(),
                    mlen,
            ...
            let mut unpacked_m = Vec::with_capacity(mlen + PQCLEAN_DILITHIUM5AES_AVX2_CRYPTO_BYTES);
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM5AES_AVX2_crypto_sign_open(
                    unpacked_m.as_mut_ptr(),
                    &mut mlen as *mut usize,
                    sm.as_ptr(),
                    sm.len(),
            ...
            assert_eq!(
                0,
                PQCLEAN_DILITHIUM5AES_AVX2_crypto_sign_signature(
                    detached_sig.as_mut_ptr(),
                    &mut smlen as *mut usize,
                    msg.as_ptr(),
                    msg.len(),
            ...
            assert!(
                smlen <= PQCLEAN_DILITHIUM5AES_AVX2_CRYPTO_BYTES,
                "Signed message length should be ≤ CRYPTO_BYTES"
            );
            assert_eq!(
                0,
