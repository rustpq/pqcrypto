...
//! # Example
//! ```
//! use pqcrypto_ntruprime::sntrup857::*;
//! let (pk, sk) = keypair();
...
simple_struct!(
    PublicKey,
    ffi::PQCLEAN_SNTRUP857_CLEAN_CRYPTO_PUBLICKEYBYTES
);
simple_struct!(
    SecretKey,
    ffi::PQCLEAN_SNTRUP857_CLEAN_CRYPTO_SECRETKEYBYTES
);
simple_struct!(
    Ciphertext,
    ffi::PQCLEAN_SNTRUP857_CLEAN_CRYPTO_CIPHERTEXTBYTES
);
simple_struct!(SharedSecret, ffi::PQCLEAN_SNTRUP857_CLEAN_CRYPTO_BYTES);
