...
//! # Examples
//! ```
//! use pqcrypto_frodo::frodokem1344shake::*;
//! let (pk, sk) = keypair();
...
simple_struct!(SharedSecret, ffi::PQCLEAN_FRODOKEM1344SHAKE_CLEAN_CRYPTO_BYTES);
...
pub fn keypair() -> (PublicKey, SecretKey) {
    ...
    assert_eq!(
        unsafe {
            ffi::PQCLEAN_FRODOKEM1344SHAKE_CLEAN_crypto_kem_keypair(pk.0.as_mut_ptr(), sk.0.as_mut_ptr())
        },
        0
    );
    (pk, sk)
