...
fn main() {
    ...
    build_clean!("rainbowI-circumzenithal");
    build_clean!("rainbowI-classic");
    build_clean!("rainbowI-compressed");
    build_clean!("rainbowIII-circumzenithal");
    build_clean!("rainbowIII-classic");
    build_clean!("rainbowIII-compressed");
    build_clean!("rainbowV-circumzenithal");
    build_clean!("rainbowV-classic");
    build_clean!("rainbowV-compressed");
}
