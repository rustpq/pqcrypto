...
pub const PQCLEAN_LEDAKEMLT12_LEAKTIME_CRYPTO_SECRETKEYBYTES: usize = 26;
pub const PQCLEAN_LEDAKEMLT12_LEAKTIME_CRYPTO_PUBLICKEYBYTES: usize = 6520;
pub const PQCLEAN_LEDAKEMLT12_LEAKTIME_CRYPTO_CIPHERTEXTBYTES: usize = 6520;
pub const PQCLEAN_LEDAKEMLT12_LEAKTIME_CRYPTO_BYTES: usize = 32;
pub const PQCLEAN_LEDAKEMLT32_LEAKTIME_CRYPTO_SECRETKEYBYTES: usize = 34;
pub const PQCLEAN_LEDAKEMLT32_LEAKTIME_CRYPTO_PUBLICKEYBYTES: usize = 12032;
pub const PQCLEAN_LEDAKEMLT32_LEAKTIME_CRYPTO_CIPHERTEXTBYTES: usize = 12032;
pub const PQCLEAN_LEDAKEMLT32_LEAKTIME_CRYPTO_BYTES: usize = 48;
pub const PQCLEAN_LEDAKEMLT52_LEAKTIME_CRYPTO_SECRETKEYBYTES: usize = 42;
pub const PQCLEAN_LEDAKEMLT52_LEAKTIME_CRYPTO_PUBLICKEYBYTES: usize = 19040;
pub const PQCLEAN_LEDAKEMLT52_LEAKTIME_CRYPTO_CIPHERTEXTBYTES: usize = 19040;
