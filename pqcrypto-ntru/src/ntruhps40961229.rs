...
simple_struct!(
    PublicKey,
    ffi::PQCLEAN_NTRUHPS40961229_CLEAN_CRYPTO_PUBLICKEYBYTES
);
simple_struct!(
    SecretKey,
    ffi::PQCLEAN_NTRUHPS40961229_CLEAN_CRYPTO_SECRETKEYBYTES
);
simple_struct!(
    Ciphertext,
    ffi::PQCLEAN_NTRUHPS40961229_CLEAN_CRYPTO_CIPHERTEXTBYTES
);
simple_struct!(
    SharedSecret,
    ffi::PQCLEAN_NTRUHPS40961229_CLEAN_CRYPTO_BYTES
);
...
pub fn keypair() -> (PublicKey, SecretKey) {
    gen_keypair!(PQCLEAN_NTRUHPS40961229_CLEAN_crypto_kem_keypair)
}
...
pub fn encapsulate(pk: &PublicKey) -> (SharedSecret, Ciphertext) {
    encap!(PQCLEAN_NTRUHPS40961229_CLEAN_crypto_kem_enc, pk)
}
...
pub fn decapsulate(ct: &Ciphertext, sk: &SecretKey) -> SharedSecret {
    decap!(PQCLEAN_NTRUHPS40961229_CLEAN_crypto_kem_dec, ct, sk)
}
